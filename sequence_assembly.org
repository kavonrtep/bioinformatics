...
The reads are Illumina paired end.
...
Additionaly, according fastqc report, the first base in reads is biased and and
...
use Quast program to calculate basing statistics of assembly and compare it to
